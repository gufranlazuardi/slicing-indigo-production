...
const MultiChannelNetwork = () => {
  return (
    <div className="bg-white flex flex-col pb-[2rem]">
      <h1 className="pl-[2rem] text-left text-gray-500 text-[30px] md:text-[40px] lg:text-[45px] xl:text-[50px] font-semibold">
        Multi Channel Network
      </h1>
      <div className="flex flex-col mr-0 lg:mr-[10rem] xl:mr-[10rem] justify-center gap-[2rem] md:gap-[2rem] lg:gap-[18rem] xl:gap-[18rem] items-center sm:flex-col md:flex-row lg:flex-row xl:flex-row">
